...
Weeks run Monday to Sunday and a week belongs to the campaign its **Thursday** falls in
(Spring Jan–Apr · Summer May–Aug · Fall Sep–Dec), so the week that straddles a campaign
boundary shows up on exactly one board. The current week's column is highlighted; a past
